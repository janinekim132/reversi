...
io.on('connection', (socket) => {
    ...
    function serverLog(...messages) {
        io.emit('log', ['****Message from the server:/n']);
    ...
    /* expected payload:
        {
            ...
            'username': the name of user joining the room
        }
    */
    /* join_room_response:
        {
            ...
            'username': user that joined the room,
    ...
    */
    ...
    socket.on('invite', (payload) => {
        ...
        if ((typeof username == 'undefined') || (username === null) || (room === "")) {
            response = {
                result: 'fail',
    ...
    /* expected payload:
        {
            ...
            'username': the name of the sender joining the room
...
/* Return true if r + dr supports playing at r and c + dc supports playing that c */
